...
public final class TextureProcessor {
    ...
    /**
     * Normalizes a player skin for rendering. This method takes ownership of
     * {@code image}: the supplied image is either returned or closed and
     * replaced with a normalized image.
     */
    @Nullable
    ...
    /**
     * Creates a new image by applying the material texture to the source
     * texture. Neither input image is modified or closed.
     */
