...
public class ButtonWithIcon extends Button {
    ...
    (GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.blitSprite(net.minecraft.client.renderer.RenderPipelines.GUI_TEXTURED, this.active ? SPRITES.enabled() : SPRITES.disabled(), this.getX(), this.getY(), this.getWidth(), this.getHeight()/*? >= 1.21.4 {*/, ModUtils.getARGBwhite(this.alpha)/*?}*/);
        int i = this.active ? 16777215 : 10526880;
        guiGraphics.blitSprite(net.minecraft.client.renderer.RenderPipelines.GUI_TEXTURED, this.icon, this.getX() + 1, this.getY() + 1, 18, 18);
        //? <1.21.11
