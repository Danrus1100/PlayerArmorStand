...
dependencies {
    ...
    modstitchImplementation(project(":common"))
...
publishMods {
    ...
    changelog = rootProject.file("CHANGELOG_MOD.md").readText()
    type = BETA
